...
export default function Hero() {
  ...
  return (
    <section className="max-w-[1650px] mx-auto flex justify-between items-center px-page-margin-x py-section-pad-y laptop-md:flex-col laptop-md:gap-y-12">
      <div className="max-w-[625px] flex flex-col gap-y-8 laptop:max-w-[500px] laptop-md:max-w-[850px] laptop-md:mx-auto">
        <div className="flex flex-col gap-y-3 laptop-md:items-center tablet:items-start">
          <h1 className="text-hero-title-font font-bold laptop-md:text-center tablet:text-left">
            Revolutionize Your Freelance Workflow with Conqur
          </h1>
          <h3 className="text-hero-subtitle-font font-semibold laptop-md:text-center laptop-md:max-w-[90%] tablet:text-left tablet-sm:max-w-none">
